...
{   
    i2s_config_t i2s_config_tx = {
        ...
        .dma_buf_count = 7,                            // number of buffers, 128 max.
    ...
    */
    ...
    .data_in_num = I2S_PIN_NO_CHANGE // GPIO_NUM_23;
     };
...
{
    i2s_set_clk(I2S_NUM_0, EXAMPLE_I2S_SAMPLE_RATE, I2S_BITS_PER_SAMPLE_16BIT, I2S_CHANNEL_STEREO);
}
...
void example_i2s_adc_dac(void*arg)
{
    ...
    while (flash_wr_size < FLASH_RECORD_SIZE) {
        ...
        i2s_read_bytes(I2S_NUM_0, i2s_read_buff, i2s_read_len, portMAX_DELAY);
    ...
    while (1) {
        ...
        for (int rd_offset = 0; rd_offset < flash_wr_size; rd_offset += FLASH_SECTOR_SIZE) {
            ...
            //send data
            //i2s_write(I2S_NUM_1, i2s_write_buff, FLASH_SECTOR_SIZE, &bytes_written, portMAX_DELAY);
            i2s_push_sample(I2S_NUM_1, (const char*) &bytes_written, portMAX_DELAY);
        ...
        while (offset < tot_size) {
            ...
            //i2s_write_bytes(I2S_NUM_1, i2s_write_buff , i2s_wr_len, portMAX_DELAY);
            offset += play_len;
